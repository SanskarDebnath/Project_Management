...
export const Card: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, children, ...props }) => (
  <div
    className={cn(
      'rounded-xl border border-slate-200/80 bg-white/80 backdrop-blur-md p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/80 dark:text-slate-100 transition-all duration-200',
      className
    )}
    {...props}
  >

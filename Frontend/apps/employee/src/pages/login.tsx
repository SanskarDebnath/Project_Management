        ...
        <div className="relative w-full grid grid-cols-1 md:grid-cols-2 gap-0 overflow-visible">
            ...
            <div className="space-y-6 relative z-20">
              <div className="flex items-center gap-3.5 border-b border-blue-800/60 dark:border-slate-800 pb-5">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-extrabold text-white leading-tight">Employee Service Ledger</h3>
                </div>
              </div>
              ...
              <div className="p-4.5 rounded-2xl bg-blue-900/40 dark:bg-slate-900/80 border border-blue-800/80 dark:border-slate-800 space-y-3 backdrop-blur-sm shadow-inner">
                <div className="flex items-center gap-2 text-cyan-400 font-bold text-xs uppercase tracking-wider">
                  <BookOpen className="w-4.5 h-4.5 text-amber-400" /> Two-Folded Employee Portal
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 rounded-xl bg-slate-950/60 border border-blue-800/60 dark:border-slate-800 text-xs space-y-2 shadow-inner">
                  <p className="flex justify-between items-center text-blue-100">
                    <span className="text-slate-400">Username:</span> <code className="font-mono font-bold text-amber-300 bg-amber-950/40 px-2 py-0.5 rounded border border-amber-500/30">dev1</code> (or <code className="font-mono font-bold text-amber-300 bg-amber-950/40 px-1.5 py-0.5 rounded border border-amber-500/30">sanskar</code>)
                  </p>
                  <p className="flex justify-between items-center text-blue-100">
                    <span className="text-slate-400">Password:</span> <code className="font-mono font-bold text-amber-300 bg-amber-950/40 px-2 py-0.5 rounded border border-amber-500/30">password</code>
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-1 relative z-50">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">Enter your credentials to open your employee portal register.</p>
            </div>
